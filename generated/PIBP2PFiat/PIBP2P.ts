...
export class OfferLock extends EthereumEvent {
  get params(): OfferLock__Params {
    return new OfferLock__Params(this);
  }
}

export class OfferLock__Params {
  _event: OfferLock;

  constructor(event: OfferLock) {
    this._event = event;
  }
...
export class PIBP2P extends SmartContract {
  ...
  offerLockedUser(param0: Address, param1: Address): boolean {
    let result = super.call("offerLockedUser", [
  ...
  try_offerLockedUser(param0: Address, param1: Address): CallResult<boolean> {
    let result = super.tryCall("offerLockedUser", [
      EthereumValue.fromAddress(param0),
      EthereumValue.fromAddress(param1)
    ]);
    if (result.reverted) {
